<template>
    <div class="body">
      ...
      <div class="content mt-5">
        ...
        <div > 
          <button @click="showForm = !showForm" class="btn btn-success mt-3 mb-4">
            Add {{ }}
          </button>
        ...
        <div class="card-body">
          ...
          <div class="row d-inline">
            ...
            <div class="float-start">
              <input type="text" name="" id="" style="margin-right: 1200px; font-size: 40px;" class="mb-3 p-3 w-100 text-center border-0" value="Pirate Crews">
              <h2 class="d-flex bg-primary shadow-lg p-2 mb-3 rounded-4 text-black">Captain: <nav class="float-end ms-lg-auto">{{ officer.pres }}</nav>  </h2>
              <h2 class="d-flex bg-primary shadow-lg p-2 mb-3 rounded-4 text-black">Vice Captain: <nav class="float-end ms-lg-auto">{{ officer.vice }}</nav>  </h2>
              <h2 class="d-flex bg-primary shadow-lg p-2 mb-3 rounded-4 text-black">Navigator: <nav class="float-end ms-lg-auto">{{ officer.sec }}</nav>  </h2>
              <h2 class="d-flex bg-primary shadow-lg p-2 mb-3 rounded-4 text-black">Cook: <nav class="float-end ms-lg-auto">{{ officer.tres }}</nav>  </h2>
              <h2 class="d-flex bg-primary shadow-lg p-2 mb-3 rounded-4 text-black">Sniper: <nav class="float-end ms-lg-auto">{{ officer.pio }}</nav>  </h2>
              <h2 class="d-flex bg-primary shadow-lg p-2 mb-3 rounded-4 text-black">Helms Man: <nav class="float-end ms-lg-auto">{{ officer.muse }}</nav>  </h2>
              <h2 class="d-flex bg-primary shadow-lg p-2 mb-3 rounded-4 text-black">Ship Wright: <nav class="float-end ms-lg-auto">{{ officer.prince }}</nav>  </h2>
